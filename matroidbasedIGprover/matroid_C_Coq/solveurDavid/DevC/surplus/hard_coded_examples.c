...
graph example_nico (graph g) {
  g.effectiveAllocPow = 15;
  g.effectiveSize = spow(g.effectiveAllocPow);

  //~ g.tab[33]->e = setMinMax(g.tab[33]->e,2,2);
  //~ g.tab[33]->color = -1;
  //~ g.tab[67]->e = setMinMax(g.tab[67]->e,2,2);
  //~ g.tab[67]->color = -1;
  //~ g.tab[135]->e = setMinMax(g.tab[135]->e,2,2);
  //~ g.tab[135]->color = -1;
  //~ g.tab[271]->e = setMinMax(g.tab[271]->e,2,2);
  //~ g.tab[271]->color = -1;

  g.tab[29]->e = setMinMax(g.tab[29]->e,4,4);
  g.tab[29]->color = -1;
  g.tab[479]->e = setMinMax(g.tab[479]->e,4,4);
  g.tab[479]->color = -1;

  g.tab[34]->e = setMinMax(g.tab[34]->e,2,2);
  g.tab[34]->color = -1;
  g.tab[68]->e = setMinMax(g.tab[68]->e,2,2);
  g.tab[68]->color = -1;
  g.tab[136]->e = setMinMax(g.tab[136]->e,2,2);
  g.tab[136]->color = -1;
  g.tab[272]->e = setMinMax(g.tab[272]->e,2,2);
  g.tab[272]->color = -1;

  g.tab[523]->e = setMinMax(g.tab[523]->e,2,2);
  g.tab[523]->color = -1;
  g.tab[703]->e = setMinMax(g.tab[703]->e,2,2);
  g.tab[703]->color = -1;
  
  g.tab[1033]->e = setMinMax(g.tab[1033]->e,2,2);
  g.tab[1033]->color = -1;
  g.tab[1183]->e = setMinMax(g.tab[1183]->e,2,2);
  g.tab[1183]->color = -1;
  
  g.tab[2053]->e = setMinMax(g.tab[2053]->e,2,2);
  g.tab[2053]->color = -1;
  g.tab[2143]->e = setMinMax(g.tab[2143]->e,2,2);
  g.tab[2143]->color = -1;
  
  g.tab[4113]->e = setMinMax(g.tab[4113]->e,2,2);
  g.tab[4113]->color = -1;
  g.tab[4383]->e = setMinMax(g.tab[4383]->e,2,2);
  g.tab[4383]->color = -1;

  g.tab[8211]->e = setMinMax(g.tab[8211]->e,2,2);
  g.tab[8211]->color = -1;
  g.tab[8511]->e = setMinMax(g.tab[8511]->e,2,2);
  g.tab[8511]->color = -1;

  g.tab[16407]->e = setMinMax(g.tab[16407]->e,2,2);
  g.tab[16407]->color = -1;
  g.tab[16767]->e = setMinMax(g.tab[16767]->e,2,2);
  g.tab[16767]->color = -1;

  // non-degeneracy conditions
  g.tab[14]->e = setMinMax(g.tab[14]->e,4,4);
  g.tab[14]->color = -1;
  g.tab[22]->e = setMinMax(g.tab[22]->e,4,4);
  g.tab[22]->color = -1;
  g.tab[28]->e = setMinMax(g.tab[28]->e,4,4);
  g.tab[28]->color = -1;
  g.tab[26]->e = setMinMax(g.tab[26]->e,4,4);
  g.tab[26]->color = -1;

  g.tab[224]->e = setMinMax(g.tab[224]->e,4,4);
  g.tab[224]->color = -1;
  g.tab[352]->e = setMinMax(g.tab[352]->e,4,4);
  g.tab[352]->color = -1;
  g.tab[448]->e = setMinMax(g.tab[448]->e,4,4);
  g.tab[448]->color = -1;
  g.tab[416]->e = setMinMax(g.tab[416]->e,4,4);
  g.tab[416]->color = -1;
