...
assert(HABCDm3 : rk(A :: B :: C :: D :: nil) >= 3).
{
	...
	apply ( rule_5 (A :: B :: D :: nil) (A :: B :: C :: D :: nil) 3 3 HABDmtmp Hcomp Hincl ).
}
...
assert(HABCm2 : rk(A :: B :: C :: nil) >= 2).
{
	...
	apply (rule_5 (A :: C :: nil) (A :: B :: C :: nil) 2 2 HACmtmp Hcomp Hincl).
}
...
assert(HABCm3 : rk(A :: B :: C :: nil) >= 3).
{
	...
	apply ( rule_2 (A :: B :: C :: nil) (A :: C :: D :: nil) (A :: C :: nil) 3 2 2 HABCDmtmp HACmtmp HACDMtmp Hincl).
}
