...
assert(HPQPpm3 : rk(P :: Q :: Pp :: nil) >= 3).
{
	assert(HPQRMtmp : rk(P :: Q :: R :: nil) <= 3) by (solve_hyps_max HPQReq HPQRM3).
	assert(HPQRPpmtmp : rk(P :: Q :: R :: Pp :: nil) >= 4) by (solve_hyps_min HPQRPpeq HPQRPpm4).
	assert(HPQeq : rk(P :: Q :: nil) = 2) by (apply LPQ with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPRPpm3 : rk(P :: R :: Pp :: nil) >= 3).
{
	assert(HPQRMtmp : rk(P :: Q :: R :: nil) <= 3) by (solve_hyps_max HPQReq HPQRM3).
	assert(HPQRPpmtmp : rk(P :: Q :: R :: Pp :: nil) >= 4) by (solve_hyps_min HPQRPpeq HPQRPpm4).
	assert(HPReq : rk(P :: R :: nil) = 2) by (apply LPR with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HQRPpm3 : rk(Q :: R :: Pp :: nil) >= 3).
{
	assert(HPQRMtmp : rk(P :: Q :: R :: nil) <= 3) by (solve_hyps_max HPQReq HPQRM3).
	assert(HPQRPpmtmp : rk(P :: Q :: R :: Pp :: nil) >= 4) by (solve_hyps_min HPQRPpeq HPQRPpm4).
	assert(HQReq : rk(Q :: R :: nil) = 2) by (apply LQR with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQPpOom3 : rk(P :: Q :: Pp :: Oo :: nil) >= 3).
{
	assert(HPQPpeq : rk(P :: Q :: Pp :: nil) = 3) by (apply LPQPp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQRPpQpeq : rk(P :: Q :: R :: Pp :: Qp :: nil) = 4) by (apply LPQRPpQp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQPpOoeq : rk(P :: Q :: Pp :: Oo :: nil) = 3) by (apply LPQPpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPRPpOom3 : rk(P :: R :: Pp :: Oo :: nil) >= 3).
{
	assert(HPRPpeq : rk(P :: R :: Pp :: nil) = 3) by (apply LPRPp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPRPpOoeq : rk(P :: R :: Pp :: Oo :: nil) = 3) by (apply LPRPpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpOoeq : rk(P :: Q :: R :: Pp :: Oo :: nil) = 4) by (apply LPQRPpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPRRpOom3 : rk(P :: R :: Rp :: Oo :: nil) >= 3).
{
	assert(HPRRpeq : rk(P :: R :: Rp :: nil) = 3) by (apply LPRRp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRpeq : rk(P :: Rp :: nil) = 2) by (apply LPRp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRRpOoeq : rk(P :: R :: Rp :: Oo :: nil) = 3) by (apply LPRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HQRRpOom3 : rk(Q :: R :: Rp :: Oo :: nil) >= 3).
{
	assert(HQRRpeq : rk(Q :: R :: Rp :: nil) = 3) by (apply LQRRp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRpeq : rk(Q :: Rp :: nil) = 2) by (apply LQRp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HQRRpOoeq : rk(Q :: R :: Rp :: Oo :: nil) = 3) by (apply LQRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQRpeq : rk(P :: Q :: Rp :: nil) = 3) by (apply LPQRp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPQRRpOoeq : rk(P :: Q :: R :: Rp :: Oo :: nil) = 4) by (apply LPQRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPPpRpOom3 : rk(P :: Pp :: Rp :: Oo :: nil) >= 3).
{
	assert(HPRpOoeq : rk(P :: Rp :: Oo :: nil) = 3) by (apply LPRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPQRalphaeq : rk(P :: Q :: R :: alpha :: nil) = 3) by (apply LPQRalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPRPpalphaeq : rk(P :: R :: Pp :: alpha :: nil) = 3) by (apply LPRPpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPRPpQpRpOoalpham4 : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: nil) >= 4).
{
	...
	assert(HPQRPpQpRpOoalphaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: nil) = 4) by (apply LPQRPpQpRpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRPpRpOoeq : rk(P :: R :: Pp :: Rp :: Oo :: nil) = 3) by (apply LPRPpRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpRpOoMtmp : rk(P :: R :: Pp :: Rp :: Oo :: nil) <= 3) by (solve_hyps_max HPRPpRpOoeq HPRPpRpOoM3).
	assert(HPRPpQpRpOoalphaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: nil) = 4) by (apply LPRPpQpRpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQPpeq : rk(Q :: Pp :: nil) = 2) by (apply LQPp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPRPpQpalphaeq : rk(P :: R :: Pp :: Qp :: alpha :: nil) = 4) by (apply LPRPpQpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPRRpalphaeq : rk(P :: R :: Rp :: alpha :: nil) = 3) by (apply LPRRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQRpOoeq : rk(P :: Q :: Rp :: Oo :: nil) = 4) by (apply LPQRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPPpRpalpham3 : rk(P :: Pp :: Rp :: alpha :: nil) >= 3).
{
	assert(HPQPpOobetaeq : rk(P :: Q :: Pp :: Oo :: beta :: nil) = 3) by (apply LPQPpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQPpOobetaMtmp : rk(P :: Q :: Pp :: Oo :: beta :: nil) <= 3) by (solve_hyps_max HPQPpOobetaeq HPQPpOobetaM3).
	assert(HPQPpRpOoalphabetaeq : rk(P :: Q :: Pp :: Rp :: Oo :: alpha :: beta :: nil) = 4) by (apply LPQPpRpOoalphabeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQPpOoalphabetam4 : rk(P :: Q :: Pp :: Oo :: alpha :: beta :: nil) >= 4).
{
	...
	assert(HPQPpRpOoalphabetaeq : rk(P :: Q :: Pp :: Rp :: Oo :: alpha :: beta :: nil) = 4) by (apply LPQPpRpOoalphabeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQPpRpOoalphabetamtmp : rk(P :: Q :: Pp :: Rp :: Oo :: alpha :: beta :: nil) >= 4) by (solve_hyps_min HPQPpRpOoalphabetaeq HPQPpRpOoalphabetam4).
	assert(HPpalphaeq : rk(Pp :: alpha :: nil) = 2) by (apply LPpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPOoalpham3 : rk(P :: Oo :: alpha :: nil) >= 3).
{
	assert(HPQPpOobetaeq : rk(P :: Q :: Pp :: Oo :: beta :: nil) = 3) by (apply LPQPpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQPpOobetaMtmp : rk(P :: Q :: Pp :: Oo :: beta :: nil) <= 3) by (solve_hyps_max HPQPpOobetaeq HPQPpOobetaM3).
	assert(HPQPpOoalphabetaeq : rk(P :: Q :: Pp :: Oo :: alpha :: beta :: nil) = 4) by (apply LPQPpOoalphabeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQROoeq : rk(P :: Q :: R :: Oo :: nil) = 4) by (apply LPQROo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPROoalpham3 : rk(P :: R :: Oo :: alpha :: nil) >= 3).
{
	assert(HPROoeq : rk(P :: R :: Oo :: nil) = 3) by (apply LPROo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQOoeq : rk(P :: Q :: Oo :: nil) = 3) by (apply LPQOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPROoalphaeq : rk(P :: R :: Oo :: alpha :: nil) = 3) by (apply LPROoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPROoalphaMtmp : rk(P :: R :: Oo :: alpha :: nil) <= 3) by (solve_hyps_max HPROoalphaeq HPROoalphaM3).
	assert(HPQROoalphaeq : rk(P :: Q :: R :: Oo :: alpha :: nil) = 4) by (apply LPQROoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQROoalphamtmp : rk(P :: Q :: R :: Oo :: alpha :: nil) >= 4) by (solve_hyps_min HPQROoalphaeq HPQROoalpham4).
	assert(HPOoalphaeq : rk(P :: Oo :: alpha :: nil) = 3) by (apply LPOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPQRQpOoalphaeq : rk(P :: Q :: R :: Qp :: Oo :: alpha :: nil) = 4) by (apply LPQRQpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HPQRPpQpRpOobetaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPQRPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRPpQpRpOobetaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPRPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPPpQpbetam3 : rk(P :: Pp :: Qp :: beta :: nil) >= 3).
{
	assert(HPPpRpOoeq : rk(P :: Pp :: Rp :: Oo :: nil) = 3) by (apply LPPpRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPPpRpOoMtmp : rk(P :: Pp :: Rp :: Oo :: nil) <= 3) by (solve_hyps_max HPPpRpOoeq HPPpRpOoM3).
	assert(HPPpQpRpOobetaeq : rk(P :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPpQpbetaMtmp : rk(Pp :: Qp :: beta :: nil) <= 2) by (solve_hyps_max HPpQpbetaeq HPpQpbetaM2).
	assert(HPPpQpbetaeq : rk(P :: Pp :: Qp :: beta :: nil) = 3) by (apply LPPpQpbeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRPpeq : rk(Q :: R :: Pp :: nil) = 3) by (apply LQRPp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpQpRpOoalphagammaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LPQRPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HQRPpQpRpOoalphagammaeq : rk(Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LQRPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRpOoeq : rk(Q :: Rp :: Oo :: nil) = 3) by (apply LQRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPpRpalphaMtmp : rk(Pp :: Rp :: alpha :: nil) <= 2) by (solve_hyps_max HPpRpalphaeq HPpRpalphaM2).
	assert(HQPpQpRpOoalphagammaeq : rk(Q :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LQPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	...
	assert(HRpalphaeq : rk(Rp :: alpha :: nil) = 2) by (apply LRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HQQpRpgammam3 : rk(Q :: Qp :: Rp :: gamma :: nil) >= 3).
{
	assert(HQQpOoalphaeq : rk(Q :: Qp :: Oo :: alpha :: nil) = 3) by (apply LQQpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HQQpOoalphaMtmp : rk(Q :: Qp :: Oo :: alpha :: nil) <= 3) by (solve_hyps_max HQQpOoalphaeq HQQpOoalphaM3).
	assert(HQQpRpOoalphagammaeq : rk(Q :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LQQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQpRpgammaMtmp : rk(Qp :: Rp :: gamma :: nil) <= 2) by (solve_hyps_max HQpRpgammaeq HQpRpgammaM2).
	assert(HQQpRpgammaeq : rk(Q :: Qp :: Rp :: gamma :: nil) = 3) by (apply LQQpRpgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRgammaMtmp : rk(Q :: R :: gamma :: nil) <= 2) by (solve_hyps_max HQRgammaeq HQRgammaM2).
	assert(HPQRgammaeq : rk(P :: Q :: R :: gamma :: nil) = 3) by (apply LPQRgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQRgammamtmp : rk(P :: Q :: R :: gamma :: nil) >= 3) by (solve_hyps_min HPQRgammaeq HPQRgammam3).
	assert(HQgammaeq : rk(Q :: gamma :: nil) = 2) by (apply LQgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpQpOogammaeq : rk(P :: Q :: R :: Pp :: Qp :: Oo :: gamma :: nil) = 4) by (apply LPQRPpQpOogamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HQRPpQpOogammaeq : rk(Q :: R :: Pp :: Qp :: Oo :: gamma :: nil) = 4) by (apply LQRPpQpOogamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRgammaMtmp : rk(Q :: R :: gamma :: nil) <= 2) by (solve_hyps_max HQRgammaeq HQRgammaM2).
	assert(HQRPpQpgammaeq : rk(Q :: R :: Pp :: Qp :: gamma :: nil) = 4) by (apply LQRPpQpgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQpeq : rk(P :: Qp :: nil) = 2) by (apply LPQp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQQpeq : rk(P :: Q :: Qp :: nil) = 3) by (apply LPQQp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPQOoalphaeq : rk(P :: Q :: Oo :: alpha :: nil) = 4) by (apply LPQOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQalphagammam3 : rk(P :: Q :: alpha :: gamma :: nil) >= 3).
{
	...
	assert(HQalphaeq : rk(Q :: alpha :: nil) = 2) by (apply LQalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQalphagammaM3 : rk(P :: Q :: alpha :: gamma :: nil) <= 3).
{
	assert(HPQRalphagammaeq : rk(P :: Q :: R :: alpha :: gamma :: nil) = 3) by (apply LPQRalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPpQpalphagammaM3 : rk(Pp :: Qp :: alpha :: gamma :: nil) <= 3).
{
	assert(HPpQpRpalphagammaeq : rk(Pp :: Qp :: Rp :: alpha :: gamma :: nil) = 3) by (apply LPpQpRpalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPRPpQpalphagammam4 : rk(P :: R :: Pp :: Qp :: alpha :: gamma :: nil) >= 4).
{
	assert(HPRPpRpOoeq : rk(P :: R :: Pp :: Rp :: Oo :: nil) = 3) by (apply LPRPpRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpRpOoMtmp : rk(P :: R :: Pp :: Rp :: Oo :: nil) <= 3) by (solve_hyps_max HPRPpRpOoeq HPRPpRpOoM3).
	assert(HPRPpQpRpOoalphagammaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LPRPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpQpRpOoalphagammamtmp : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) >= 4) by (solve_hyps_min HPRPpQpRpOoalphagammaeq HPRPpQpRpOoalphagammam4).
	assert(HPRPpeq : rk(P :: R :: Pp :: nil) = 3) by (apply LPRPp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpmtmp : rk(P :: R :: Pp :: nil) >= 3) by (solve_hyps_min HPRPpeq HPRPpm3).
	assert(Hincl : incl (P :: R :: Pp :: nil) (list_inter (P :: R :: Pp :: Rp :: Oo :: nil) (P :: R :: Pp :: Qp :: alpha :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
...
assert(HPQbetagammam3 : rk(P :: Q :: beta :: gamma :: nil) >= 3).
{
	assert(HPQgammaeq : rk(P :: Q :: gamma :: nil) = 3) by (apply LPQgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpQpOobetagammaeq : rk(P :: Q :: R :: Pp :: Qp :: Oo :: beta :: gamma :: nil) = 4) by (apply LPQRPpQpOobetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HQRPpQpOobetagammaeq : rk(Q :: R :: Pp :: Qp :: Oo :: beta :: gamma :: nil) = 4) by (apply LQRPpQpOobetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQRgammaMtmp : rk(Q :: R :: gamma :: nil) <= 2) by (solve_hyps_max HQRgammaeq HQRgammaM2).
	assert(HQRPpQpbetagammaeq : rk(Q :: R :: Pp :: Qp :: beta :: gamma :: nil) = 4) by (apply LQRPpQpbetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQalphabetagammaM3 : rk(P :: Q :: alpha :: beta :: gamma :: nil) <= 3).
{
	assert(HPQalphagammaeq : rk(P :: Q :: alpha :: gamma :: nil) = 3) by (apply LPQalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQalphagammaMtmp : rk(P :: Q :: alpha :: gamma :: nil) <= 3) by (solve_hyps_max HPQalphagammaeq HPQalphagammaM3).
	assert(HPQbetagammaeq : rk(P :: Q :: beta :: gamma :: nil) = 3) by (apply LPQbetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPRPpRpalphaeq : rk(P :: R :: Pp :: Rp :: alpha :: nil) = 3) by (apply LPRPpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	...
	assert(HPPpRpalphaeq : rk(P :: Pp :: Rp :: alpha :: nil) = 3) by (apply LPPpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HPpQpRpalphaeq : rk(Pp :: Qp :: Rp :: alpha :: nil) = 3) by (apply LPpQpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPalphabetagammam3 : rk(P :: alpha :: beta :: gamma :: nil) >= 3).
{
	...
	assert(HPbetaeq : rk(P :: beta :: nil) = 2) by (apply LPbeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPalphabetagammaM3 : rk(P :: alpha :: beta :: gamma :: nil) <= 3).
{
	assert(HPQalphabetagammaeq : rk(P :: Q :: alpha :: beta :: gamma :: nil) = 3) by (apply LPQalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPpQpalphabetagammaM3 : rk(Pp :: Qp :: alpha :: beta :: gamma :: nil) <= 3).
{
	assert(HPpQpalphagammaeq : rk(Pp :: Qp :: alpha :: gamma :: nil) = 3) by (apply LPpQpalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPpQpalphagammaMtmp : rk(Pp :: Qp :: alpha :: gamma :: nil) <= 3) by (solve_hyps_max HPpQpalphagammaeq HPpQpalphagammaM3).
	assert(HPpQpbetagammaeq : rk(Pp :: Qp :: beta :: gamma :: nil) = 3) by (apply LPpQpbetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPpQpbetagammaMtmp : rk(Pp :: Qp :: beta :: gamma :: nil) <= 3) by (solve_hyps_max HPpQpbetagammaeq HPpQpbetagammaM3).
	assert(HPpQpgammaeq : rk(Pp :: Qp :: gamma :: nil) = 3) by (apply LPpQpgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HPQRPpQpRpOoalphabetagammaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPQRPpQpRpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQRPpQpRpOoalphabetagammamtmp : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPQRPpQpRpOoalphabetagammaeq HPQRPpQpRpOoalphabetagammam4).
	assert(HQpOomtmp : rk(Qp :: Oo :: nil) >= 2) by (solve_hyps_min HQpOoeq HQpOom2).
	assert(Hincl : incl (Qp :: Oo :: nil) (list_inter (Q :: Qp :: Oo :: nil) (P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
	assert(HT1 : equivlist (P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) (Q :: Qp :: Oo :: P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil)) by (clear_all_rk;my_inO).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRPpQpRpOoalphabetagammaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPRPpQpRpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpQpRpOoalphabetagammamtmp : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPRPpQpRpOoalphabetagammaeq HPRPpQpRpOoalphabetagammam4).
	assert(HRRpmtmp : rk(R :: Rp :: nil) >= 2) by (solve_hyps_min HRRpeq HRRpm2).
	assert(Hincl : incl (R :: Rp :: nil) (list_inter (R :: Rp :: Oo :: nil) (P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
	assert(HT1 : equivlist (P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) (R :: Rp :: Oo :: P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil)) by (clear_all_rk;my_inO).
...
assert(HPPpQpRpalphabetagammam4 : rk(P :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil) >= 4).
{
	assert(HPRPpRpalphaeq : rk(P :: R :: Pp :: Rp :: alpha :: nil) = 3) by (apply LPRPpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpRpalphaMtmp : rk(P :: R :: Pp :: Rp :: alpha :: nil) <= 3) by (solve_hyps_max HPRPpRpalphaeq HPRPpRpalphaM3).
	assert(HPRPpQpRpalphabetagammaeq : rk(P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil) = 4) by (apply LPRPpQpRpalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPRPpQpRpalphabetagammamtmp : rk(P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPRPpQpRpalphabetagammaeq HPRPpQpRpalphabetagammam4).
	assert(HPPpRpalphaeq : rk(P :: Pp :: Rp :: alpha :: nil) = 3) by (apply LPPpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPPpRpalphamtmp : rk(P :: Pp :: Rp :: alpha :: nil) >= 3) by (solve_hyps_min HPPpRpalphaeq HPPpRpalpham3).
	assert(Hincl : incl (P :: Pp :: Rp :: alpha :: nil) (list_inter (P :: R :: Pp :: Rp :: alpha :: nil) (P :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
...
assert(HPPpQpalphabetagammam4 : rk(P :: Pp :: Qp :: alpha :: beta :: gamma :: nil) >= 4).
{
	assert(HPpQpRpalphaeq : rk(Pp :: Qp :: Rp :: alpha :: nil) = 3) by (apply LPpQpRpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPpQpRpalphaMtmp : rk(Pp :: Qp :: Rp :: alpha :: nil) <= 3) by (solve_hyps_max HPpQpRpalphaeq HPpQpRpalphaM3).
	assert(HPPpQpRpalphabetagammaeq : rk(P :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil) = 4) by (apply LPPpQpRpalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPPpQpRpalphabetagammamtmp : rk(P :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPPpQpRpalphabetagammaeq HPPpQpRpalphabetagammam4).
	assert(HPpQpalphaeq : rk(Pp :: Qp :: alpha :: nil) = 3) by (apply LPpQpalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
...
assert(HPQalphabetagammam2 : rk(P :: Q :: alpha :: beta :: gamma :: nil) >= 2).
{
	assert(HPQRPpQpeq : rk(P :: Q :: R :: Pp :: Qp :: nil) = 4) by (apply LPQRPpQp with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQRPpQpMtmp : rk(P :: Q :: R :: Pp :: Qp :: nil) <= 4) by (solve_hyps_max HPQRPpQpeq HPQRPpQpM4).
	assert(HPQRPpQpalphabetagammaeq : rk(P :: Q :: R :: Pp :: Qp :: alpha :: beta :: gamma :: nil) = 4) by (apply LPQRPpQpalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQRPpQpalphabetagammamtmp : rk(P :: Q :: R :: Pp :: Qp :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPQRPpQpalphabetagammaeq HPQRPpQpalphabetagammam4).
	assert(HPQeq : rk(P :: Q :: nil) = 2) by (apply LPQ with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQmtmp : rk(P :: Q :: nil) >= 2) by (solve_hyps_min HPQeq HPQm2).
	assert(Hincl : incl (P :: Q :: nil) (list_inter (P :: Q :: R :: Pp :: Qp :: nil) (P :: Q :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
...
assert(HPQalphabetagammam3 : rk(P :: Q :: alpha :: beta :: gamma :: nil) >= 3).
{
	assert(HQQpOoalphaeq : rk(Q :: Qp :: Oo :: alpha :: nil) = 3) by (apply LQQpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HQQpOoalphaMtmp : rk(Q :: Qp :: Oo :: alpha :: nil) <= 3) by (solve_hyps_max HQQpOoalphaeq HQQpOoalphaM3).
	assert(HPQQpOoalphabetagammaeq : rk(P :: Q :: Qp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPQQpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPQQpOoalphabetagammamtmp : rk(P :: Q :: Qp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPQQpOoalphabetagammaeq HPQQpOoalphabetagammam4).
	assert(HQalphaeq : rk(Q :: alpha :: nil) = 2) by (apply LQalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HQalphamtmp : rk(Q :: alpha :: nil) >= 2) by (solve_hyps_min HQalphaeq HQalpham2).
	assert(Hincl : incl (Q :: alpha :: nil) (list_inter (Q :: Qp :: Oo :: alpha :: nil) (P :: Q :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
...
assert(HalphabetagammaM2 : rk(alpha :: beta :: gamma :: nil) <= 2).
{
	assert(HPalphabetagammaeq : rk(P :: alpha :: beta :: gamma :: nil) = 3) by (apply LPalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	assert(HPalphabetagammaMtmp : rk(P :: alpha :: beta :: gamma :: nil) <= 3) by (solve_hyps_max HPalphabetagammaeq HPalphabetagammaM3).
	assert(HPpQpalphabetagammaeq : rk(Pp :: Qp :: alpha :: beta :: gamma :: nil) = 3) by (apply LPpQpalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
	...
	assert(HPPpQpalphabetagammaeq : rk(P :: Pp :: Qp :: alpha :: beta :: gamma :: nil) = 4) by (apply LPPpQpalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ;try assumption).
