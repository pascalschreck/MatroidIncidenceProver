...
{
	assert(HROoeq : rk(R :: Oo :: nil) = 2) by (apply LROo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQOoeq : rk(Q :: Oo :: nil) = 2) by (apply LQOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPOoeq : rk(P :: Oo :: nil) = 2) by (apply LPOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPRRpOom3 : rk(P :: R :: Rp :: Oo :: nil) >= 3).
{
	assert(HPROoeq : rk(P :: R :: Oo :: nil) = 3) by (apply LPROo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRRpOoeq : rk(P :: R :: Rp :: Oo :: nil) = 3) by (apply LPRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPRRpOomtmp : rk(P :: R :: Rp :: Oo :: nil) >= 3) by (solve_hyps_min HPRRpOoeq HPRRpOom3).
	assert(HRpOoeq : rk(Rp :: Oo :: nil) = 2) by (apply LRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HQRRpOom3 : rk(Q :: R :: Rp :: Oo :: nil) >= 3).
{
	assert(HQROoeq : rk(Q :: R :: Oo :: nil) = 3) by (apply LQROo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HQRRpOoeq : rk(Q :: R :: Rp :: Oo :: nil) = 3) by (apply LQRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPQOoeq : rk(P :: Q :: Oo :: nil) = 3) by (apply LPQOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPQRRpOoeq : rk(P :: Q :: R :: Rp :: Oo :: nil) = 4) by (apply LPQRRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPPpRpOom3 : rk(P :: Pp :: Rp :: Oo :: nil) >= 3).
{
	assert(HPRpOoeq : rk(P :: Rp :: Oo :: nil) = 3) by (apply LPRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPRalphaMtmp : rk(P :: R :: alpha :: nil) <= 2) by (solve_hyps_max HPRalphaeq HPRalphaM2).
	assert(HPQRalphaeq : rk(P :: Q :: R :: alpha :: nil) = 3) by (apply LPQRalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HQPpQpOoalpham3 : rk(Q :: Pp :: Qp :: Oo :: alpha :: nil) >= 3).
{
	...
	assert(HPpOoeq : rk(Pp :: Oo :: nil) = 2) by (apply LPpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPQRpOoeq : rk(P :: Q :: Rp :: Oo :: nil) = 4) by (apply LPQRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPPpRpalpham3 : rk(P :: Pp :: Rp :: alpha :: nil) >= 3).
{
	assert(HPQPpOobetaeq : rk(P :: Q :: Pp :: Oo :: beta :: nil) = 3) by (apply LPQPpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQPpOobetaMtmp : rk(P :: Q :: Pp :: Oo :: beta :: nil) <= 3) by (solve_hyps_max HPQPpOobetaeq HPQPpOobetaM3).
	assert(HPQPpRpOoalphabetaeq : rk(P :: Q :: Pp :: Rp :: Oo :: alpha :: beta :: nil) = 4) by (apply LPQPpRpOoalphabeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPOoalpham3 : rk(P :: Oo :: alpha :: nil) >= 3).
{
	assert(HPQPpOobetaeq : rk(P :: Q :: Pp :: Oo :: beta :: nil) = 3) by (apply LPQPpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQPpOobetaMtmp : rk(P :: Q :: Pp :: Oo :: beta :: nil) <= 3) by (solve_hyps_max HPQPpOobetaeq HPQPpOobetaM3).
	assert(HPQPpOoalphabetaeq : rk(P :: Q :: Pp :: Oo :: alpha :: beta :: nil) = 4) by (apply LPQPpOoalphabeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPROoalphaeq : rk(P :: R :: Oo :: alpha :: nil) = 3) by (apply LPROoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPROoalphaMtmp : rk(P :: R :: Oo :: alpha :: nil) <= 3) by (solve_hyps_max HPROoalphaeq HPROoalphaM3).
	assert(HPQROoalphaeq : rk(P :: Q :: R :: Oo :: alpha :: nil) = 4) by (apply LPQROoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQROoalphamtmp : rk(P :: Q :: R :: Oo :: alpha :: nil) >= 4) by (solve_hyps_min HPQROoalphaeq HPQROoalpham4).
	assert(HPOoalphaeq : rk(P :: Oo :: alpha :: nil) = 3) by (apply LPOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HPQRPpQpRpOobetaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPQRPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQRPpQpRpOobetamtmp : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: beta :: nil) >= 4) by (solve_hyps_min HPQRPpQpRpOobetaeq HPQRPpQpRpOobetam4).
	assert(HQpOoeq : rk(Qp :: Oo :: nil) = 2) by (apply LQpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRPpQpRpOobetaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPRPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPPpQpbetam3 : rk(P :: Pp :: Qp :: beta :: nil) >= 3).
{
	assert(HPPpRpOoeq : rk(P :: Pp :: Rp :: Oo :: nil) = 3) by (apply LPPpRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPPpRpOoMtmp : rk(P :: Pp :: Rp :: Oo :: nil) <= 3) by (solve_hyps_max HPPpRpOoeq HPPpRpOoM3).
	assert(HPPpQpRpOobetaeq : rk(P :: Pp :: Qp :: Rp :: Oo :: beta :: nil) = 4) by (apply LPPpQpRpOobeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPpQpbetaMtmp : rk(Pp :: Qp :: beta :: nil) <= 2) by (solve_hyps_max HPpQpbetaeq HPpQpbetaM2).
	assert(HPPpQpbetaeq : rk(P :: Pp :: Qp :: beta :: nil) = 3) by (apply LPPpQpbeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpQpRpOoalphagammaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LPQRPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HQRPpQpRpOoalphagammaeq : rk(Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: gamma :: nil) = 4) by (apply LQRPpQpRpOoalphagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQRpOoeq : rk(Q :: Rp :: Oo :: nil) = 3) by (apply LQRpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPPpOoMtmp : rk(P :: Pp :: Oo :: nil) <= 2) by (solve_hyps_max HPPpOoeq HPPpOoM2).
	assert(HPQRPpQpOogammaeq : rk(P :: Q :: R :: Pp :: Qp :: Oo :: gamma :: nil) = 4) by (apply LPQRPpQpOogamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HQRPpQpOogammaeq : rk(Q :: R :: Pp :: Qp :: Oo :: gamma :: nil) = 4) by (apply LQRPpQpOogamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQRgammaMtmp : rk(Q :: R :: gamma :: nil) <= 2) by (solve_hyps_max HQRgammaeq HQRgammaM2).
	assert(HQRPpQpgammaeq : rk(Q :: R :: Pp :: Qp :: gamma :: nil) = 4) by (apply LQRPpQpgamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HPQOoalphaeq : rk(P :: Q :: Oo :: alpha :: nil) = 4) by (apply LPQOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPQalphagammam3 : rk(P :: Q :: alpha :: gamma :: nil) >= 3).
{
	...
	assert(HQalphaeq : rk(Q :: alpha :: nil) = 2) by (apply LQalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HQRPpQpOobetagammaeq : rk(Q :: R :: Pp :: Qp :: Oo :: beta :: gamma :: nil) = 4) by (apply LQRPpQpOobetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
assert(HPalphabetagammam3 : rk(P :: alpha :: beta :: gamma :: nil) >= 3).
{
	...
	assert(HPbetaeq : rk(P :: beta :: nil) = 2) by (apply LPbeta with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
...
{
	assert(HQQpOoMtmp : rk(Q :: Qp :: Oo :: nil) <= 2) by (solve_hyps_max HQQpOoeq HQQpOoM2).
	assert(HPQRPpQpRpOoalphabetagammaeq : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPQRPpQpRpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQRPpQpRpOoalphabetagammamtmp : rk(P :: Q :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPQRPpQpRpOoalphabetagammaeq HPQRPpQpRpOoalphabetagammam4).
	assert(HQpOoeq : rk(Qp :: Oo :: nil) = 2) by (apply LQpOo with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HQpOomtmp : rk(Qp :: Oo :: nil) >= 2) by (solve_hyps_min HQpOoeq HQpOom2).
	assert(Hincl : incl (Qp :: Oo :: nil) (list_inter (Q :: Qp :: Oo :: nil) (P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
...
{
	assert(HRRpOoMtmp : rk(R :: Rp :: Oo :: nil) <= 2) by (solve_hyps_max HRRpOoeq HRRpOoM2).
	assert(HPRPpQpRpOoalphabetagammaeq : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPRPpQpRpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPRPpQpRpOoalphabetagammamtmp : rk(P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPRPpQpRpOoalphabetagammaeq HPRPpQpRpOoalphabetagammam4).
	assert(HRRpmtmp : rk(R :: Rp :: nil) >= 2) by (solve_hyps_min HRRpeq HRRpm2).
	assert(Hincl : incl (R :: Rp :: nil) (list_inter (R :: Rp :: Oo :: nil) (P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
	assert(HT1 : equivlist (P :: R :: Pp :: Qp :: Rp :: Oo :: alpha :: beta :: gamma :: nil) (R :: Rp :: Oo :: P :: R :: Pp :: Qp :: Rp :: alpha :: beta :: gamma :: nil)) by (clear_all_rk;my_inO).
...
assert(HPQalphabetagammam3 : rk(P :: Q :: alpha :: beta :: gamma :: nil) >= 3).
{
	assert(HQQpOoalphaeq : rk(Q :: Qp :: Oo :: alpha :: nil) = 3) by (apply LQQpOoalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HQQpOoalphaMtmp : rk(Q :: Qp :: Oo :: alpha :: nil) <= 3) by (solve_hyps_max HQQpOoalphaeq HQQpOoalphaM3).
	assert(HPQQpOoalphabetagammaeq : rk(P :: Q :: Qp :: Oo :: alpha :: beta :: gamma :: nil) = 4) by (apply LPQQpOoalphabetagamma with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HPQQpOoalphabetagammamtmp : rk(P :: Q :: Qp :: Oo :: alpha :: beta :: gamma :: nil) >= 4) by (solve_hyps_min HPQQpOoalphabetagammaeq HPQQpOoalphabetagammam4).
	assert(HQalphaeq : rk(Q :: alpha :: nil) = 2) by (apply LQalpha with (P := P) (Q := Q) (R := R) (Pp := Pp) (Qp := Qp) (Rp := Rp) (Oo := Oo) (alpha := alpha) (beta := beta) (gamma := gamma) ; assumption).
	assert(HQalphamtmp : rk(Q :: alpha :: nil) >= 2) by (solve_hyps_min HQalphaeq HQalpham2).
	assert(Hincl : incl (Q :: alpha :: nil) (list_inter (Q :: Qp :: Oo :: alpha :: nil) (P :: Q :: alpha :: beta :: gamma :: nil))) by (repeat clear_all_rk;my_inO).
